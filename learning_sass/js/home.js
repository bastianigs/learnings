...
for (let i = 0; i < 2; i++) {
    cardElem.push({
        Key: document.querySelectorAll( ".home-page__card-key" )[i],
        Value: document.querySelectorAll( ".home-page__card-value" )[i],
        Icon: document.querySelectorAll( ".home-page__card-img" )[i]
    })
}

/* next customer */
const clientElem = {
    appTime: document.querySelector( ".home-page__next-header span" ),
    Name: document.querySelector( ".home-page__next-client-name" ),
    Visits: document.querySelector( ".home-page__next-client-visits span" ),
    Tel: document.querySelector( ".home-page__next-client-tel" ),
    Package: document.querySelector( ".home-page__next-services p:first-child" ),
    Services: document.querySelector( ".home-page__next-services ul" ),
    payCheck: { 
            div: document.querySelector( ".home-page__next-services-paid" ),
            iconDiv: document.querySelector( ".home-page__next-services-paid div" ),
            icon: document.querySelector( ".home-page__next-services-paid div img")
    }
}

/* appointments */
const nextAppsJSON = "../assets/json/appointments.json";
const list = document.querySelector( ".home-page__appointments ul" );
...
function renderNextClient() {
    ...
    const paid = true;
    if (!paid) {
        clientElem.payCheck.div.classList.add( "home-page__next-services-paid--not" );
...
async function renderAppointments() {
    ...
    res.forEach( (client, id) => {
        ...
        newItem.innerHTML = `
                            <div class="home-page__appointments-data">
